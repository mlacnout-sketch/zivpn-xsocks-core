...
class MockHttpClientResponse extends Fake implements HttpClientResponse {
  ...
  Stream<S> transform<S>(StreamTransformer<List<int>, S> streamTransformer) {
    ...
    final jsonStr = '[{"tag_name": "1.0.1", "assets": [{"name": "app.apk", "content_type": "application/vnd.android.package-archive", "browser_download_url": "http://example.com/app.apk", "size": 1024}]}]';
